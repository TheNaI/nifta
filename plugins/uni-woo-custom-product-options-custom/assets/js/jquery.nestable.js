;(function($, window, document, undefined) {
     ...
     * https://github.com/ozdemirburak/nestable-fork ----fork
     */
    ...
    Plugin.prototype = {
        ...
        rebuild: function( args ) {
            var newStructure = args[0];
            this.reset();
            $(this.el).empty();
            this.options.json = newStructure;
            if(this.options.json !== undefined) {
                this._build();
            }
        },
        /* end of added by mr.psiho */
        ...
        serialize: function() {
            var data, list = this, step = function(level) {
                ...
                items.each(function() {
                    ...
                    /* added by mr.psiho */
                    pid = parseInt(li.parent(list.options.listNodeName).parent(list.options.itemNodeName).attr('data-id')) || '';
                    item.parentid = pid;
                    /* end of added by mr.psiho  */
        ...
        asNestedSet: function() {
            ...
            function traverse(item, depth, lft) {
                ...
                pid = $(item).parent(o.listNodeName + '.' + o.listClass).parent(o.itemNodeName + '.' + o.itemClass).attr('data-id') || null;
